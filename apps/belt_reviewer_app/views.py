...
def new(request):
    ...
    return render(request, 'belt_reviewer_app/new.html', context)
...
def show(request, id):
    ...
    return render(request, 'belt_reviewer_app/show.html', { 'book' : book })
...
def show_user(request, id):
    ...
    return render(request, 'belt_reviewer_app/show_user.html', { 'user' : user })